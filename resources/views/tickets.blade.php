    ...
    <div class="wrapper">
      ...
      <aside id="left-sidebar-nav">
        <ul id="slide-out" class="side-nav fixed leftside-navigation">
                    ...
                    <ul id="profile-dropdown" class="dropdown-content">
                        <li><a href="{{ route('logout') }}" onclick="event.preventDefault();
                          ...
                          <form id="logout-form" action="{{ route('logout') }}" method="POST" style="display: none;">
                                        @csrf
                                    </form><i class="mdi-hardware-keyboard-tab"></i> Logout</a>
                        </li>
                    </ul>
                </div>
                <div class="col col s8 m8 l8">
            ...
            <li class="bold"><a href="/admin" class="waves-effect waves-cyan"><i class="mdi-editor-border-color"></i> Order Food</a>
            </li>
                <li class="no-padding">
          ...
          <div class="divider"></div>
									...
									<a href="#"class="collection-item">
                                        <div class="row">
                                            ...
                                            <div class="col s2">
                                            <span class="task-cat cyan"></span></div>											
                                            <div class="col s2">
                                            <span class="task-cat grey darken-3"></span></div>
                                            <div class="col s2">
