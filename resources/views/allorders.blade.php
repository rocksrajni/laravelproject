        ...
        <div class="navbar-fixed">
            <nav class="navbar-color">
                <div class="nav-wrapper">
                    <ul class="left">                      
                      <li><h1 class="logo-wrapper"><a href="/admin" class="brand-logo darken-1"><img src="#" alt="logo"></a> <span class="logo-text">Logo</span></h1></li>
                    </ul>
                </div>
            </nav>
        </div>
    ...
    <div class="wrapper">
      ...
      <aside id="left-sidebar-nav">
        <ul id="slide-out" class="side-nav fixed leftside-navigation">
            ...
            <li class="bold"><a href="/admin" class="waves-effect waves-cyan"><i class="mdi-editor-border-color"></i> Food Menu</a>
            </li>
                <li class="no-padding">
...
<div id="work-collections" class="seaction">
				...
				@foreach($orders as $order)
						<li class="collection-item avatar">
                              ...
                              <p><span class="collection-header">Order No.</span><strong>{{$order->id}}</strong></p>
							...
							<p><strong>Address: </strong>{{$order->add}}</p>
                            ...
                            <div class="row">
                            <div class="col s7">
                            <p class="collections-title"><strong>Product Name:</strong>{{$order->name}}</p>
                            </div>
                            <div class="col s2">
                            <span> Price</span>
                            </div>
